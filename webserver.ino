...
void generateHTMLFooter() {
  client.println("</div> <div class=\"row \"> <div class=\"col-md-2 bg-main pt-2\"> </div> <div class=\"col-10\"> <footer class=\"sticky-footer bg-white\"> <div class=\"container\"> <div class=\"copyright text-center my-auto\"> <a href=\"https://www.thomastheunen.eu\" class=\"text-decoration-none text-secondary\"><span>Copyright © Thomas Theunen 2019</span></a> </div> </div> </footer> </div> </div> </div></body></html>");
}
  ...
  if (client) {
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        header += c;
        if (c == '\n') {
          if (currentLine.indexOf("GET /well.html") >= 0){
            isWellPage = true;
          }
